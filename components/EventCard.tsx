  ...
  return (
    <article className="group flex flex-col overflow-hidden rounded-xl bg-white shadow-card ring-1 ring-navy/5 transition-shadow hover:shadow-card-hover">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <dl className="mt-3 space-y-1.5 text-sm text-charcoal/75">
          <div className="flex items-center gap-2">
            <CalendarDays size={15} className="shrink-0 text-charcoal/50" />
            <dd>{event.date}</dd>
          </div>
          <div className="flex items-start gap-2">
            <MapPin size={15} className="mt-0.5 shrink-0 text-charcoal/50" />
